      ...
      <>
        <div className="container w-100%">
          ...
          <div className="col-sm-6">
            <h2 className="text-capitalize text-dark ">Ambulance Contact Details</h2>
          </div>
          <div className="col-sm-6">
              ...
              <table className="table table-bordered">
                <thead className="bg-primary text-light">
                  <tr>
                    ...
                    <th className="col-5 text-center fs-5">Address</th>
                    <th className="col-3 text-center fs-5">Ambulance_Contact</th>
                  </tr>
                </thead>
                <tbody>
                    <tr>
                      <td className="col-4 text-center fs-5 fw-bold">{this.state.hospitalname}</td>
                      <td className="col-5 text-center fs-5 fw-bold">{this.state.address}</td>
                      <td className="col-3 text-center fs-5 fw-bold">{this.state.ambulancecontact}</td>
                    </tr>
                </tbody>
              </table>
            </div>
